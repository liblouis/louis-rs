...
#+BEGIN_SRC shell
  $ LOUIS_TABLE_PATH=~/src/liblouis/tables cargo run -- check --brief ~/src/liblouis/tests/braille-specs/*.yaml ~/src/liblouis/tests/yaml/*.yaml
  [...]
  ================================================================================
  644690 tests run:
  333129 successes [52%]
  275202 failures [43%]
  23921 expected failures [4%]
  12438 unexpected successes [2%]
#+END_SRC
