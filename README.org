...
Currently, the re-implementation passes around 80% of the liblouis
test suite for forward translation successfully. If you consider both
forward and backward translation the success rate is less, namely 52%.
...
#+BEGIN_SRC shell
  $ cargo run -- translate --tracing ~/src/liblouis/tables/de-comp6.utb
  > Guten Tag
  ⠈⠛⠥⠞⠑⠝⠀⠈⠞⠁⠛
  ┌───┬──────┬────┬────────────────┐
  │   │ From │ To │ Rule           │
...
#+BEGIN_SRC shell
$ LOUIS_TABLE_PATH=~/src/liblouis/tables:~/src/liblouis cargo run -- translate --tracing ~/src/liblouis/tables/en-us-g1.ctb 
> 123st
⠼⠁⠃⠉⠌
┌───┬──────┬────┬──────────────┐
│   │ From │ To │ Rule         │
...
#+BEGIN_SRC shell
  ...
  │ ar-ar-g2.yaml                               │ 168    │ 60.1%     │ 39.9%    │ 0.0%     │ 0.0%       │
  ...
  │ de-g1-detailed-specs.yaml                   │ 476    │ 42.0%     │ 52.3%    │ 5.3%     │ 0.4%       │
  │ de-g1.yaml                                  │ 486    │ 43.4%     │ 45.5%    │ 10.7%    │ 0.4%       │
  │ en-GB-g2.yaml                               │ 528    │ 52.8%     │ 22.9%    │ 22.9%    │ 1.3%       │
  ...
  │ ms-my-g2.yaml                               │ 1432   │ 95.6%     │ 4.3%     │ 0.1%     │ 0.0%       │
  │ tr.yaml                                     │ 1654   │ 41.2%     │ 28.6%    │ 30.1%    │ 0.1%       │
  │ sw-ke.yaml                                  │ 1884   │ 44.3%     │ 55.7%    │ 0.0%     │ 0.0%       │
  │ ve-g2.yaml                                  │ 2038   │ 45.8%     │ 54.1%    │ 0.0%     │ 0.0%       │
  ...
  │ ny-mw.yaml                                  │ 3250   │ 48.2%     │ 51.8%    │ 0.0%     │ 0.0%       │
  ...
  ┌─────────────────────────────────────────────┌────────┌───────────┌──────────┌──────────┌────────────┐
  │ Total                                       │ 513571 │ 52.7%     │ 45.2%    │ 2.0%     │ 0.1%       │
  └─────────────────────────────────────────────└────────└───────────└──────────└──────────└────────────┘
#+END_SRC
