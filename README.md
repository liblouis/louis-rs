...
That said, the `louis` binary currently passes around 97% of the
...
Run all YAML tests:
    ...
    │ en-ueb-g2_backward_no_dis.yaml              │ 1       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ en-us-comp8-ext-back_harness.yaml           │ 1       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    ...
    │ de-g2-detailed-specs.yaml                   │ 2       │ 50.0%     │ 0.0%     │ 50.0%    │ 0.0%       │
    ...
    │ before_begmidword.yaml                      │ 5       │ 60.0%     │ 40.0%    │ 0.0%     │ 0.0%       │
    ...
    │ cs-comp8_harness.yaml                       │ 8       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ de-comp6.yaml                               │ 8       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ de-de-comp8.yaml                            │ 8       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ el-backward.yaml                            │ 8       │ 25.0%     │ 75.0%    │ 0.0%     │ 0.0%       │
    │ en-nabcc.yaml                               │ 8       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ en-ueb-math.yaml                            │ 8       │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ hr-8dots_harness.yaml                       │ 8       │ 75.0%     │ 0.0%     │ 25.0%    │ 0.0%       │
    ...
    │ syllable.yaml                               │ 13      │ 23.1%     │ 76.9%    │ 0.0%     │ 0.0%       │
    │ he-IL.yaml                                  │ 14      │ 71.4%     │ 21.4%    │ 7.1%     │ 0.0%       │
    │ tt.yaml                                     │ 15      │ 80.0%     │ 6.7%     │ 13.3%    │ 0.0%       │
    ...
    │ ro-g0.yaml                                  │ 23      │ 78.3%     │ 13.0%    │ 8.7%     │ 0.0%       │
    ...
    │ ru.yaml                                     │ 142     │ 52.1%     │ 45.8%    │ 2.1%     │ 0.0%       │
    │ sl-g1.yaml                                  │ 143     │ 58.7%     │ 35.0%    │ 4.9%     │ 1.4%       │
    │ ar-ar-g2.yaml                               │ 168     │ 95.2%     │ 4.8%     │ 0.0%     │ 0.0%       │
    │ hu-hu-comp8_harness.yaml                    │ 173     │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ hu-hu-g1_braille_input_backward.yaml        │ 174     │ 80.5%     │ 18.4%    │ 0.6%     │ 0.6%       │
    │ hu-hu-g1_braille_input_forward.yaml         │ 175     │ 99.4%     │ 0.6%     │ 0.0%     │ 0.0%       │
    │ pl-g1.yaml                                  │ 202     │ 90.1%     │ 9.9%     │ 0.0%     │ 0.0%       │
    │ lv_harness.yaml                             │ 214     │ 98.6%     │ 0.0%     │ 1.4%     │ 0.0%       │
    │ de-g2-sbs.yaml                              │ 262     │ 42.7%     │ 33.6%    │ 23.7%    │ 0.0%       │
    │ ar-ar-g1.yaml                               │ 266     │ 93.2%     │ 6.8%     │ 0.0%     │ 0.0%       │
    │ es-g2.yaml                                  │ 266     │ 85.3%     │ 12.0%    │ 2.6%     │ 0.0%       │
    │ hu-hu-g2_dictionary_numbers.yaml            │ 272     │ 99.3%     │ 0.7%     │ 0.0%     │ 0.0%       │
    │ eo-g1_harness.yaml                          │ 285     │ 99.6%     │ 0.4%     │ 0.0%     │ 0.0%       │
    │ de-blista-dictionary.yaml                   │ 294     │ 13.9%     │ 0.0%     │ 85.7%    │ 0.3%       │
    │ ethio-g1_harness.yaml                       │ 301     │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ en-ueb-g2_backward.yaml                     │ 348     │ 82.2%     │ 17.2%    │ 0.6%     │ 0.0%       │
    │ hbo.yaml                                    │ 469     │ 44.8%     │ 54.4%    │ 0.9%     │ 0.0%       │
    │ de-g0-detailed-specs.yaml                   │ 476     │ 63.4%     │ 31.1%    │ 5.0%     │ 0.4%       │
    │ de-g1-detailed-specs.yaml                   │ 476     │ 62.4%     │ 31.9%    │ 5.0%     │ 0.6%       │
    │ de-g1.yaml                                  │ 486     │ 81.7%     │ 7.2%     │ 11.1%    │ 0.0%       │
    │ de-g2.yaml                                  │ 500     │ 83.6%     │ 5.8%     │ 10.6%    │ 0.0%       │
    │ en-gb-comp8.yaml                            │ 508     │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ hu-hu-g2_harness.yaml                       │ 511     │ 91.4%     │ 8.6%     │ 0.0%     │ 0.0%       │
    │ en-GB-g2.yaml                               │ 528     │ 70.6%     │ 8.5%     │ 16.5%    │ 4.4%       │
    │ de-g0.yaml                                  │ 550     │ 82.7%     │ 6.9%     │ 10.4%    │ 0.0%       │
    │ ur-pk-g2.yaml                               │ 578     │ 86.5%     │ 4.8%     │ 8.5%     │ 0.2%       │
    │ en-ueb-symbols_harness.yaml                 │ 593     │ 99.5%     │ 0.0%     │ 0.5%     │ 0.0%       │
    │ es-g0-g1.yaml                               │ 992     │ 72.5%     │ 0.1%     │ 27.4%    │ 0.0%       │
    │ pt.yaml                                     │ 1163    │ 95.4%     │ 1.5%     │ 3.0%     │ 0.1%       │
    │ ms-my-g2.yaml                               │ 1432    │ 97.0%     │ 2.9%     │ 0.1%     │ 0.0%       │
    │ tr.yaml                                     │ 1654    │ 60.4%     │ 9.4%     │ 30.0%    │ 0.1%       │
    │ sw-ke.yaml                                  │ 1884    │ 87.9%     │ 12.1%    │ 0.0%     │ 0.0%       │
    │ en-g3.yaml                                  │ 1944    │ 78.5%     │ 21.3%    │ 0.2%     │ 0.0%       │
    │ ve-g2.yaml                                  │ 2038    │ 97.5%     │ 2.4%     │ 0.0%     │ 0.0%       │
    │ fa-ir-g1-harness.yaml                       │ 2108    │ 95.8%     │ 4.2%     │ 0.0%     │ 0.0%       │
    │ fr-bfu-g2.yaml                              │ 2145    │ 92.8%     │ 7.2%     │ 0.0%     │ 0.0%       │
    │ en-ueb.yaml                                 │ 2232    │ 68.8%     │ 19.8%    │ 11.2%    │ 0.1%       │
    │ hu-hu-g1_harness.yaml                       │ 2532    │ 98.4%     │ 1.6%     │ 0.0%     │ 0.0%       │
    │ lo.yaml                                     │ 2637    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ en-ueb-computer-code.yaml                   │ 2818    │ 42.6%     │ 56.1%    │ 1.3%     │ 0.0%       │
    │ ny-mw.yaml                                  │ 3250    │ 97.8%     │ 2.2%     │ 0.0%     │ 0.0%       │
    │ st-g2.yaml                                  │ 3774    │ 97.1%     │ 2.4%     │ 0.1%     │ 0.4%       │
    │ xh-g2.yaml                                  │ 4048    │ 96.5%     │ 3.4%     │ 0.0%     │ 0.0%       │
    │ hi_harness.yaml                             │ 4118    │ 90.5%     │ 8.5%     │ 0.9%     │ 0.2%       │
    │ fa-ir-comp8-harness.yaml                    │ 4212    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ ta-ta-g1_harness.yaml                       │ 4690    │ 97.2%     │ 2.0%     │ 0.8%     │ 0.0%       │
    │ pa.yaml                                     │ 5027    │ 93.5%     │ 6.4%     │ 0.0%     │ 0.0%       │
    │ zh-tw-dictionary.yaml                       │ 5139    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ ja-rokutenkanji.yaml                        │ 7010    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ ml.yaml                                     │ 7524    │ 88.2%     │ 11.5%    │ 0.1%     │ 0.2%       │
    │ ar-ar-g1_harness.yaml                       │ 7596    │ 99.8%     │ 0.2%     │ 0.0%     │ 0.0%       │
    │ lg-ug-g1.yaml                               │ 8283    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ rw-rw-g1.yaml                               │ 9839    │ 95.6%     │ 4.4%     │ 0.0%     │ 0.0%       │
    │ de-g2-dictionary.yaml                       │ 9897    │ 99.6%     │ 0.4%     │ 0.0%     │ 0.0%       │
    │ de-g1-dictionary.yaml                       │ 9998    │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ sw-ke-dictionary.yaml                       │ 10966   │ 90.8%     │ 9.2%     │ 0.0%     │ 0.0%       │
    │ de-g0-detailed-dictionary.yaml              │ 19996   │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ de-g1-detailed-dictionary.yaml              │ 19996   │ 100.0%    │ 0.0%     │ 0.0%     │ 0.0%       │
    │ hu-hu-g1_dictionary_numbers.yaml            │ 34246   │ 99.0%     │ 1.0%     │ 0.0%     │ 0.0%       │
    │ en-g3-dictionary.yaml                       │ 40000   │ 95.5%     │ 4.5%     │ 0.0%     │ 0.0%       │
    │ afr-za-g2.yaml                              │ 51824   │ 96.5%     │ 3.5%     │ 0.0%     │ 0.0%       │
    ...
    │ en-ueb-g2-dictionary_harness.yaml           │ 213167  │ 93.9%     │ 6.1%     │ 0.1%     │ 0.0%       │
    │ da-dk-g26-dictionary_harness_1993.yaml      │ 236434  │ 99.9%     │ 0.0%     │ 0.0%     │ 0.0%       │
    │ da-dk-g26-dictionary_harness.yaml           │ 236435  │ 99.9%     │ 0.0%     │ 0.0%     │ 0.0%       │
    │ da-dk-g28-dictionary_harness_1993.yaml      │ 475546  │ 99.9%     │ 0.1%     │ 0.0%     │ 0.0%       │
    │ da-dk-g28-dictionary_harness.yaml           │ 475548  │ 96.3%     │ 3.6%     │ 0.0%     │ 0.0%       │
    ┌─────────────────────────────────────────────┌─────────┌───────────┌──────────┌──────────┌────────────┐
    │ Total                                       │ 2221658 │ 97.4%     │ 2.0%     │ 0.5%     │ 0.0%       │
    └─────────────────────────────────────────────└─────────└───────────└──────────└──────────└────────────┘
