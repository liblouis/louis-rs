...
|--------------------------------------------|--------:|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------|
| `en-ueb-g2-dictionary_harness`             |  ≈4 300 | Match-rule candidate selection: rule weight vs. table-definition order. ADR still DRAFT — the direct fix regresses the suite by exposing a deeper gap.                                  | L    |
...
| `afr-za-g2`                                |  ≈2 600 | Unclassified. Large enough to be one cause rather than a tail.                                                                                                                          | M    |
| `da-dk-g28-dictionary_harness` (+ `_1993`) |  ≈1 900 | Residual backward failures after `83f6b1d` seeded the letter dots class from every contraction opcode. Was the largest cluster here; needs a fresh survey to say what the remainder is. | M    |
